...
static uint8 tms_lookup[16][256][2] __attribute__((section (".persistent")));   /* Expand BD, PG data into 8-bit pixels (G1,G2) */
static uint8 tms_obj_lut[16*256] __attribute__((section (".persistent")));      /* Look up priority between SG and display pixels */
static uint8 txt_lookup[256][2] __attribute__((section (".persistent")));       /* Expand BD, PG data into 8-bit pixels (TX) */
static uint8 bp_expand[256][8] __attribute__((section (".persistent")));        /* Expand PG data into 8-bit pixels */
